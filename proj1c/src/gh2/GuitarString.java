...
public class GuitarString {
     ...
     */
    public void tic() {
        // Remove the first element and compute the average.
        double noise1 = buffer.removeFirst();
        double noise2 = buffer.get(0);
        double average = (noise1 + noise2) / 2;
        double newNoise = average * DECAY;
        // Update the deque.
